...
in which $det(\mathbf{A})=abd+bfg+cdh-ceg-fha-ibd=\color{red}{tr(\mathbf{\Omega}^2_a}\color{blue}{\mathbf{\Omega}^2_d})N+N^3+N^3-N^2tr(\mathbf{\Omega}^2_a)-N^2tr(\mathbf{\Omega}^2_d)-N^3=N[\color{red}{tr(\mathbf{\Omega^2}_a} \color{blue}{\mathbf{\Omega^2}_d)}-tr(\mathbf{\Omega^2}_a)N-tr(\mathbf{\Omega}^2_d)N+N^2]$.

Under orthogonal coding for additive and dominance scheme,
$\color  {red}{tr(\mathbf{\Omega}_a}\color{blue}{\mathbf{\Omega}_d)}=\color  {red}{tr(\mathbf{\Omega}_a)}\color{blue}{tr{(\mathbf{\Omega}_d)}}$, and $det(\mathbf {A})=N[\color{red}{tr(\mathbf{\Omega}_a)}-N][\color{blue}{tr(\mathbf{\Omega}_d)}-N]$
