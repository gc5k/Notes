...
It may be related to high-order moments for multivariate normal distribution, see [Isserlis Theorem](https://en.wikipedia.org/wiki/Isserlis%27_theorem), published in *Biometrika*, 12:[134-139](https://www.jstor.org/stable/2331932?seq=1). However, Isserlis Theorem works for normal distribution only, but it is not "normal" for a standardized locus.
...
And similarly, $\hat{\sigma}^2_{\beta}=\frac{y^Ty-\hat{\mathbf{\beta}}^T\mathbf{\Lambda}\hat{b}}{n-m}$
